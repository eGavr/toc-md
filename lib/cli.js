...
module.exports = require('coa').Cmd()
    ...
    .opt()
        ...
        .end()
    .opt()
        .name('ignoreFirstHeader')
        .title('Ignores the first header during the generation of a TOC')
        .long('ignore-first-header')
        .short('i')
        .flag()
        .end()
    .opt()
        .name('maxDepth')
        .title('Sets the maximum depth of TOC\'s headers (default: 6)')
        .long('max-depth')
        .short('m')
        .def(6)
        .val(function (val) {
